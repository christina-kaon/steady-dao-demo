...
const immortalSister: XianxiaStory = {
  ...
  opening: {
    ...
    events: [
      ...
      {
        type: "narration",
        text: "九州灵脉衰竭，已经三十七年。\n昔日散在山野的灵气，如今被各大仙门收束进矿脉、药圃与护宗大阵——修行不再是机缘，成了按根骨与功勋分配的配额。",
      },
      {
        type: "narration",
        text: "北境，**凌霄宗**。\n十二峰以主峰为轴犬牙相列，镇守北境门户；主峰之后的雪线上藏着**剑冢**——历代宗门佩剑葬于此处，也睡着一柄百年无主的绝世灵剑。",
      },
      {
        type: "narration",
        text: "**「太初」**。\n上一次出匣择主，还是百余年前：据说那夜剑鸣彻夜，十二峰积雪尽落。此后百年，历次大典它都缄默如石——谁也没挑。",
      },
      {
        type: "narration",
        text: "明日清晨，它将再一次出匣。\n十二名候选者已经选定。其中押注最多、议论最多的名字，是一个入门时连木剑都嫌磨手的年轻剑修——\n**沈砚**。就是你。",
      },
      {
        type: "narration",
        text: "**主峰授剑院 · 授剑大典前一日 · 未时**",
      },
      {
        type: "narration",
        text: "北境的天光难得这般透亮。\n露天石坪晒得暖意微泛，几株古松把斑驳碎影拓在青石长案上；山风穿过回廊，卷着远处洗剑池的水汽，一阵，又一阵。",
      },
      {
        type: "narration",
        text: "长案一角压着一方礼殿的仪程木牌，墨字工整——\n**「卯时三刻 · 十二峰剑冢 · 太初出匣择主」**\n木牌旁搁着一只铜洗，水面浮着两枚松针，纹丝不动。",
      },
      {
        type: "narration",
        text: "你就坐在这方长案边。\n沉睡百年的绝世灵剑**「太初」**明晨择主，十二名候选者，你是其中之一——此刻院中只有你，和这一案的日光。",
      },
      {
        type: "narration",
        text: "先到的是声音。\n院门外一串跌跌撞撞的脚步由远及近——礼殿杂务弟子**桑迟**抱着一沓描金剑谱和红木赌签冲进门来，手里还拎着支饱蘸朱砂的细毫笔，衣角扫过铜洗，惊得水面松针直打转。他把东西一股脑放到长案另一头，撑着膝盖直喘。",
      },
      {
        type: "dialogue",
        person: "sang_chi",
      ...
      },
      {
        type: "dialogue",
        person: "sang_chi",
        text: "你给句准话——明日剑冢里十二柄候选灵剑，太初当真会挑你么？真被你领回来，你打算给它改个什么名字？我可指着押你这注换下半年的中品灵石呢！",
      },
      {
        type: "narration",
        text: "桑迟话音未落，院外青石小径上传来一声带笑的轻咳。\n**闻照雪**信步入画：素白道袍的袖口还挽在小臂，周身带着洗剑池的冷泉水汽。早你十年入门的师姐走到案旁，把一盏刚晾好的热茶挪到你右手边，指尖在瓷盏沿上试了试温。",
      },
      {
        type: "dialogue",
        person: "wen_zhaoxue",
        text: "别听桑迟胡闹。太初是认主极挑剔的老脾气——你练剑收式总爱多挽半朵剑花，当年在试剑坪险些削了长老的袍角，它真挑了你，怕是头一天就嫌你手欠。",
      },
      {
        type: "dialogue",
        person: "wen_zhaoxue",
      ...
      {
        type: "narration",
        text: "说话间，她极自然地扯过桑迟手里那张写满人名的红木赌签，指节在案上轻轻一敲——随即当着桑迟的面，从腰间解下一枚温润的**青玉佩**，「啪嗒」按在押注簿上。",
      },
      {
        type: "dialogue",
        person: "wen_zhaoxue",
        text: "喏，我也押一份。你刚入门那会儿连木剑都嫌磨手，如今倒成了宗门议论最多的候选人。真要是太初选了你，剑柄上刻个什么正经名号？总不能像你小时候养的灵雀，叫什么“飞雪”“滚圆”吧？",
      },
      {
        type: "narration",
        text: "日光穿过松针，落在摊开的押注簿上。\n你的名字那一栏还空着——桑迟的朱砂笔尖悬在正上方，一滴红将坠未坠。",
      },
    ],
  },
  chapterBackgrounds: {
...
const steadyDao: XianxiaStory = {
  ...
  opening: {
    ...
    events: [
      ...
      {
        type: "narration",
        text: `洪荒表面仍讲清修、机缘与师承。\n天庭、大教和仙门却已开始重新计算香火、气运与因果——没人公布大劫何时开始，但各峰收到的历练名册、外务符牒和凡间祈文一年密过一年。大人物们在用最寻常的差事，丈量每个人的软肋。`,
      },
      {
        type: "narration",
        text: `东胜神洲，**度仙门**。\n并非洪荒大宗，只占着几条尚能吐纳的灵脉。门中弟子大多相信，灾祸离自己还远。`,
      },
      {
        type: "narration",
        text: `门中最不起眼的，是**小琼峰**：山不高，弟子少，峰主看似只会种药炼丹、不擅经营。\n没人知道这座山从山脚第一块石头起就被人重新布过——三十三年，**八百座微光阵法**，一层叠着一层，伪装成天然的石林、溪涧与雾。`,
      },
      {
        type: "narration",
        text: `峰主姓李，名长寿。三十三年只修一个字：**稳**。\n——就是你。`,
      },
      {
        type: "narration",
        text: `**度仙门 · 小琼峰前庭 · 午后**`,
      ...
      {
        type: "narration",
        text: `午后的阳光透过矮竹，筛在草屋前庭的青石案上。\n案角几卷粗纸晒得泛出微温的草木香，庭前药圃里灵草叶尖的露水刚收干，远处只有风声。`,
      },
      {
        type: "narration",
        text: `案上摊着一摞黄麻纸，页页都是同一部**《稳字经》**——最上面那张的页脚用朱笔标着小字：\n**「第三十六遍 · 未完」**\n纸镇旁横着一把老竹戒尺，尺身包浆温润，是三十三年里被手掌磨出来的。`,
      },
      {
        type: "narration",
      ...
      {
        type: "narration",
        text: `她把纤细的手腕递到你眼皮底下晃了晃，嘴角噙着藏不住的机灵笑意。\n还没等你的戒尺落下去——先翻过前庭矮墙的，是一股浓郁清洌的酒香。\n二十九岁的小师叔**酒玖**踏着旧草鞋轻巧落地，宽袖一抖，两只粗陶酒碗与一坛贴着破天峰封条的**「醉仙颜」**稳稳落在石案正中。`,
      },
      {
        type: "dialogue",
        person: "jiu_jiu",
      ...
      {
        type: "narration",
        text: `清风拂过庭前药草——\n石案之下，由你亲手布设的地脉灵引，毫无征兆地轻颤了一下。\n三十三年，你在小琼峰周遭埋了**八百座微光阵法**。此刻，西崖最外层那座伪装成天然石林的低阶迷阵，被一股极其微弱的气息精准越过。`,
      },
      {
        type: "narration",
        text: `来人修为低微，却怀揣着度仙门正规的**外务符牒**，正沿着小琼峰明面上唯一的公开山径摸索上来。\n灵娥与酒玖毫无察觉，仍在为茶盏与桂花糕斗嘴。\n触碰轻得够不上一次正式刺探——指诀微动，西崖的三具替身纸人与「陷空阵」三息之内就能把人无声捆进石缝；任他再走两步，或许就能看清是哪个不长眼的同门走漏了路线。`,
      },
      {
        type: "dialogue",
        person: "lan_linge",
